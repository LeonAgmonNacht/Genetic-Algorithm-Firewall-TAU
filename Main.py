...
def read_malicious_packets():
    ...
    """
    return pandas.DataFrame() # read_packets(MALICIOUS_PACKETS_PCAP_FILE_PATH)
...
def read_clean_packets():
    ...
    :return: a DataFrame with the relevant data retrieved from the packets
    """
    return pandas.DataFrame() # read_packets(CLEAN_PACKETS_PCAP_FILE_PATH)
